...
Deno.serve(async (req) => {
  ...
  const prompt = [
    ...
    "4. 学生中文答案如果出现明显错别字，不能算对；例如 hostess 的标准释义为“女主人/空姐”，学生答“女朱人”，应判 correct=false。",
    "5. 例如 cripple 的标准释义若为“n.跛子/残废的人；v.使成残废/削弱”，学生只答“残疾的”，应判 correct=false，因为这是形容词而非名词或动词。",
    "6. 如果学生答案过宽、过窄到明显不是该词含义，或只是相关但不等价，判 correct=false。",
    "7. 汉译英拼写不在本函数复核范围内；输入给你的均为英译汉。",
